...
type PropsType = NativeStackScreenProps<HomeStackParamList, 'ReceiptProductScreen'>;
const ReceiptProductScreen: React.FC<PropsType> = props => {
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.contaninerAll}
                ...
                <View style={styles.payment}>
                    ...
                    <Pressable style={styles.paymentInfo}>
...
export default ReceiptProductScreen
