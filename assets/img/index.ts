...
export const IC_LOCATION = require('../img/location.png')
export const IC_ORDER = require('../img/order.png')
export const IC_WALLET = require('../img/wallet.png')
export const IC_STAR = require('../img/star.png')
export const IC_MORE = require('../img/more.png')